...
<div class="container-fluid px-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            <a href="{{ route('vehicle-usage.index') }}" class="btn btn-sm btn-secondary">
    ...
    <div class="card shadow-sm">
        <div class="card-header">
            <h6 class="m-0 font-weight-bold text-primary">Semua Log Penggunaan Kendaraan</h6>
        </div>
                ...
                <table class="table table-hover table-striped mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if($log->assignment && $log->assignment->vehicle)
                                    {{ $log->assignment->vehicle->registration_number }}
                                @else
                                    -
                                @endif
                            </td>
                            <td>
                                @if($log->assignment && $log->assignment->driver)
                                    {{ $log->assignment->driver->name }}
                                @else
                                    -
                                @endif
                            </td>
                            ...
                            <td>
                                <div class="btn-group">
                                    <a href="{{ route('vehicle-usage.logs.show', [$log->assignment_id, $log]) }}" class="btn btn-sm btn-info">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="{{ route('vehicle-usage.logs.edit', [$log->assignment_id, $log]) }}" class="btn btn-sm btn-primary">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form action="{{ route('vehicle-usage.logs.destroy', [$log->assignment_id, $log]) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                        ...
                        @empty
                        <tr>
                            <td colspan="10" class="text-center py-4">Belum ada log penggunaan kendaraan</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
