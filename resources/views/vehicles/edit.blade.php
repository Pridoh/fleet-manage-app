        ...
        <div class="col-md-12">
            <div class="card shadow-sm">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('vehicles.show', $vehicle) }}" class="btn btn-sm btn-secondary">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('vehicles.update', $vehicle) }}">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select @error('vehicle_type_id') is-invalid @enderror" 
                                    ...
                                    @foreach($vehicleTypes as $type)
                                        <option value="{{ $type->vehicle_type_id }}" {{ old('vehicle_type_id', $vehicle->vehicle_type_id) == $type->vehicle_type_id ? 'selected' : '' }}>
                                            {{ $type->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select @error('location_id') is-invalid @enderror" 
                                    ...
                                    @foreach($locations as $location)
                                        <option value="{{ $location->location_id }}" {{ old('location_id', $vehicle->location_id) == $location->location_id ? 'selected' : '' }}>
                                            {{ $location->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" class="form-control @error('capacity') is-invalid @enderror" 
                                    id="capacity" name="capacity" value="{{ old('capacity', $vehicle->capacity) }}" min="1">
                                @error('capacity')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select @error('ownership_type') is-invalid @enderror" 
                                    ...
                                    @foreach($ownershipTypes as $type)
                                        <option value="{{ $type }}" {{ old('ownership_type', $vehicle->ownership_type) == $type ? 'selected' : '' }}>
                            ...
                            <div class="col-md-4 mb-3 leasing-field">
                                ...
                                <input type="text" class="form-control @error('lease_company') is-invalid @enderror" 
                                    id="lease_company" name="lease_company" value="{{ old('lease_company', $vehicle->lease_company) }}">
                                @error('lease_company')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-2 mb-3 leasing-field">
                                ...
                                <input type="date" class="form-control @error('lease_start_date') is-invalid @enderror" 
                                    id="lease_start_date" name="lease_start_date" value="{{ old('lease_start_date', $vehicle->lease_start_date ? $vehicle->lease_start_date->format('Y-m-d') : '') }}">
                            ...
                            <div class="col-md-2 mb-3 leasing-field">
                                ...
                                <input type="date" class="form-control @error('lease_end_date') is-invalid @enderror" 
                                    id="lease_end_date" name="lease_end_date" value="{{ old('lease_end_date', $vehicle->lease_end_date ? $vehicle->lease_end_date->format('Y-m-d') : '') }}">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="date" class="form-control @error('last_service_date') is-invalid @enderror" 
                                    id="last_service_date" name="last_service_date" value="{{ old('last_service_date', $vehicle->last_service_date ? $vehicle->last_service_date->format('Y-m-d') : '') }}">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="date" class="form-control @error('next_service_date') is-invalid @enderror" 
                                    id="next_service_date" name="next_service_date" value="{{ old('next_service_date', $vehicle->next_service_date ? $vehicle->next_service_date->format('Y-m-d') : '') }}">
                        ...
                        <div class="d-flex justify-content-end">
                            <a href="{{ route('vehicles.show', $vehicle) }}" class="btn btn-secondary me-2">Batal</a>
