        ...
        <div class="col-md-12">
            <div class="card shadow-sm">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Edit Data Driver</h5>
                    <a href="{{ route('drivers.show', $driver) }}" class="btn btn-sm btn-secondary">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('drivers.update', $driver) }}">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="date" class="form-control @error('birth_date') is-invalid @enderror" 
                                    id="birth_date" name="birth_date" value="{{ old('birth_date', $driver->date_of_birth ? $driver->date_of_birth->format('Y-m-d') : '') }}" required>
                                @error('birth_date')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select @error('license_type') is-invalid @enderror" 
                                    ...
                                    <option value="B1" {{ old('license_type', $driver->license_type) == 'B1' ? 'selected' : '' }}>SIM B1</option>
                                    <option value="B2" {{ old('license_type', $driver->license_type) == 'B2' ? 'selected' : '' }}>SIM B2</option>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="date" class="form-control @error('license_expiry') is-invalid @enderror" 
                                    id="license_expiry" name="license_expiry" value="{{ old('license_expiry', $driver->license_expiry ? $driver->license_expiry->format('Y-m-d') : '') }}" required>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select @error('location_id') is-invalid @enderror" 
                                    ...
                                    @foreach($locations as $location)
                                        <option value="{{ $location->location_id }}" {{ old('location_id', $driver->location_id) == $location->location_id ? 'selected' : '' }}>
                                            {{ $location->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="date" class="form-control @error('join_date') is-invalid @enderror" 
                                    id="join_date" name="join_date" value="{{ old('join_date', $driver->join_date ? $driver->join_date->format('Y-m-d') : '') }}" required>
                                @error('join_date')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select @error('status') is-invalid @enderror" 
                                    ...
                                    <option value="day_off" {{ old('status', $driver->status) == 'day_off' ? 'selected' : '' }}>Libur</option>
                                    <option value="sick" {{ old('status', $driver->status) == 'sick' ? 'selected' : '' }}>Sakit</option>
                        ...
                        <div class="d-flex justify-content-end">
                            <a href="{{ route('drivers.show', $driver) }}" class="btn btn-secondary me-2">Batal</a>
