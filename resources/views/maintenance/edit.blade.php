        ...
        <div class="col-lg-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Form Edit Maintenance</h6>
                </div>
                <div class="card-body">
                    @if ($errors->any())
                    ...
                    <form action="{{ route('maintenance.update', $maintenance) }}" method="POST">
                                ...
                                <div class="card bg-light">
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control @error('vehicle_id') is-invalid @enderror" id="vehicle_id" name="vehicle_id" required>
                                                ...
                                                @foreach($vehicles as $vehicle)
                                                    <option value="{{ $vehicle->vehicle_id }}" {{ (old('vehicle_id', $maintenance->vehicle_id) == $vehicle->vehicle_id) ? 'selected' : '' }}>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control @error('odometer_reading') is-invalid @enderror" id="odometer_reading" name="odometer_reading" value="{{ old('odometer_reading', $maintenance->odometer_reading) }}">
                                ...
                                <div class="card bg-light">
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="date" class="form-control @error('start_date') is-invalid @enderror" id="start_date" name="start_date" value="{{ old('start_date', $maintenance->start_date ? $maintenance->start_date->format('Y-m-d') : '') }}" required>
                                            @error('start_date')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="date" class="form-control @error('end_date') is-invalid @enderror" id="end_date" name="end_date" value="{{ old('end_date', $maintenance->end_date ? $maintenance->end_date->format('Y-m-d') : '') }}">
                                            @error('end_date')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" class="form-control @error('cost') is-invalid @enderror" id="cost" name="cost" value="{{ old('cost', $maintenance->cost) }}">
                                                    @error('cost')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control @error('performed_by') is-invalid @enderror" id="performed_by" name="performed_by" value="{{ old('performed_by', $maintenance->performed_by) }}">
                                                    @error('performed_by')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                        ...
                        <div class="alert alert-warning">
                            ...
                            Mengubah status maintenance dapat mempengaruhi ketersediaan kendaraan.
                            Jika status diubah menjadi <strong>Dalam Proses</strong>, status kendaraan akan diubah menjadi <strong>Maintenance</strong>.
                        </div>
                        
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a href="{{ route('maintenance.index') }}" class="btn btn-secondary me-md-2">
